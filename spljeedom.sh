...
while true; do 
    ...
    curl -s -d "apikey=renseigner ici votre clef api jeedom&type=httpRemoteEvent&eqId=189&param2842=$amplitude" http://votre ip jeedom/core/api/jeeApi.php >/dev/null 2>&1
done
